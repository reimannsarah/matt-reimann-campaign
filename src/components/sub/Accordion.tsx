  ...
  return (
    <div onClick={() => setAccordionIsOpen(!accordionIsOpen)} className="py-2">
      <button className="flex justify-between w-full">
        <h1 className="font-header text-4xl text-primary py-3">{props.title}</h1>
        <svg
      ...
      >
        <div className="overflow-hidden">
          <strong><p className="py-5 px-8 text-primary font-body text-xl">{props.subtitle}</p></strong>
          <ul className="list-disc list-outside py-3 px-10 font-body text-secondary text-lg">
