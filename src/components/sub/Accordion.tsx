  ...
  return (
    <div onClick={() => setAccordionIsOpen(!accordionIsOpen)} className="py-2">
      <button className="flex justify-between items-center w-full">
        <h1 className="font-header text-2xl md:text-4xl text-white md:text-green py-3">{props.title}</h1>
        <svg
      ...
      >
        <div className="overflow-hidden">
          <strong><p className="py-5 px-8 text-white md:text-green font-body md:text-xl">{props.subtitle}</p></strong>
